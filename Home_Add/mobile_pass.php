...
?>
    ...
    <section id="sec1">
        <div id="div1">
            <img src="\Chalo\Images\Chalo_card\mobile_pass1.png" id="img1" />
        </div>
        <div id="div2">
    ...
    <section id="sec1">
        ...
        <div id="div1">
            <img src="\Chalo\Images\Chalo_card\mobile_pass.png" id="img1" />
        </div>
    </section>
    ...
    <section id="sec2">
        ...
        <div id="div5">
            ...
            <div id="div7">
                <div id="div8">
                    <img src="\Chalo\Images\Chalo_card\upi.png" id="img2"></img>
                </div>
                <p id="p4">Pay with UPI, Netbanking or M-Wallet</p>
            </div>
            <div id="div9">
                <div id="div8">
                    <img src="\Chalo\Images\Chalo_card\right.jpg" id="img3"></img>
                </div>
