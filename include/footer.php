<footer>
        <div class="div17">
            <div>
                <h2 class="head4">Contact Us</h2>
            </div>
            <div>
                <p class="p6">F-611 Tower 2, Seawoods Grand Central,</p>
                <p class="p6">Navi Mumbai 400706 INDIA</p>
                <p class="p6">Email: ‍<a href="mailto:‍‍‍contact@chalo.com" class="p7">
                    contact@chalo.com</a></p>
                <p class="p6">Corporate Identification Number (CIN):</p>
                <p class="p6">U72900MH2014PTC254181</p>
            </div>
        </div>

        <div class="div18">
            <div>
                <h2 class="head5">Social Connect</h2>
            </div>
            <div class="div19">
